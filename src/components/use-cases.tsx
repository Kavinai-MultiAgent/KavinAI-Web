                ...
                <div className="use_cases_cards flex flex-wrap justify-center mx-auto">
                    <div className="use_cases md:w-1/3 w-full p-4">
                        <div className="bg-blue-100 dark:bg-gray-800 h-full p-6 rounded-md">
                            ...
                            <p className='mt-2'>Use terminal in natural language instead of write commands</p>
                        </div>
                    </div>
                    <div className="use_cases md:w-1/3 w-full p-4">
                        <div className="bg-blue-100 dark:bg-gray-800 h-full p-6 rounded-md">
                            ...
                            <p className='mt-2'>Create folder, open browser, open your favorite song, and do everything by just staying in one app</p>
                        </div>
                    </div>
                    <div className="use_cases md:w-1/3 w-full p-4">
                        <div className="bg-blue-100 dark:bg-gray-800 h-full p-6 rounded-md">
                            ...
                            <p className='mt-2'>Use ai to create your project just by using prompts</p>
                        </div>
                    </div>
                </div>
            </div>
