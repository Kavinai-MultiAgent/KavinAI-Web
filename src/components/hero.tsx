...
import app_image from '../../public/app_image.jpg';

export const Hero = () => {
  return (
    <main className='w-full h-screen bg-[#ffffff] dark:bg-[#111827]'>
      <section className="tag_line text-center md:mx-0 mx-5">
        <h1 className='md:text-6xl text-4xl font-bold pt-16 lg:w-[40%] md:w-[60%] w-[100%] mx-auto md:leading-[4rem] leading-[3rem]'><span className='text-purple-500'>MultiAgents</span> Made To Understand You</h1>
        ...
        <Button className='mt-5 md:text-xl text-lg px-7 py-7'>Download for desktop</Button>
      </section>
